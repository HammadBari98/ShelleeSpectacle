...
(function(require) {
    ...
    (function() {
        var config = {
            map: {
                '*': {
                    'Magento_Checkout/js/action/select-payment-method': 'Mageprince_Paymentfee/js/action/payment/select-payment-method'
                }
            }
        };
    ...
    (function() {
        var config = {
            map: {
                '*': {
                    titan_customjs: 'Titan_EyeTestForm/js/titan_custom'
                }
            }
        };
        require.config(config);
    ...
    $(document).ready(function() {
        $(".filter-title strong").click(function() {
            if (window.sidebar_open) {
                ...
                $("#maincontent .sidebar.sidebar-main").removeClass("fixed-sidebar");
                window.sidebar_open = false;
            } else {
                $("#narrow-by-list").show();
                $(".block-content.filter-content").show();
                $("#maincontent .sidebar.sidebar-main").addClass("fixed-sidebar");
